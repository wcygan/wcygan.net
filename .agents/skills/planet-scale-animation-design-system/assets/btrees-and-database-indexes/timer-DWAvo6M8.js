...
h.prototype = I.prototype = {
  ...
  on: function (n, e) {
    ...
    if (arguments.length < 2) {
      for (; ++o < y; )
        if ((i = (n = r[o]).type) && (i = O(t[i], n.name))) return i;
      return;
    }
    if (e != null && typeof e != "function")
      throw new Error("invalid callback: " + e);
    for (; ++o < y; )
      if ((i = (n = r[o]).type)) t[i] = g(t[i], n.name, e);
      else if (e == null) for (i in t) t[i] = g(t[i], n.name, null);
    return this;
  },
  copy: function () {
    var n = {},
  ...
  call: function (n, e) {
    ...
    for (o = this._[n], r = 0, i = o.length; r < i; ++r) o[r].value.apply(e, t);
  },
...
function O(n, e) {
  for (var t = 0, r = n.length, i; t < r; ++t)
    if ((i = n[t]).name === e) return i.value;
}
function g(n, e, t) {
  for (var r = 0, i = n.length; r < i; ++r)
    if (n[r].name === e) {
      ((n[r] = E), (n = n.slice(0, r).concat(n.slice(r + 1))));
      break;
    }
...
_.prototype = D.prototype = {
  ...
  restart: function (n, e, t) {
    ...
    ((t = (t == null ? T() : +t) + (e == null ? 0 : +e)),
      !this._next &&
        s !== this &&
        (s ? (s._next = this) : (w = this), (s = this)),
      (this._call = n),
      (this._time = t),
      v());
  },
...
function P() {
  (T(), ++a);
  for (var n = w, e; n; )
    ((e = l - n._time) >= 0 && n._call.call(void 0, e), (n = n._next));
  --a;
}
function d() {
  ((l = (p = c.now()) + m), (a = u = 0));
...
function q() {
  for (var n, e = w, t, r = 1 / 0; e; )
    e._call
      ? (r > e._time && (r = e._time), (n = e), (e = e._next))
      : ((t = e._next), (e._next = null), (e = n ? (n._next = t) : (w = t)));
  ((s = n), v(r));
}
function v(n) {
  if (!a) {
    ...
    var e = n - l;
    e > 24
      ? (n < 1 / 0 && (u = setTimeout(d, n - c.now() - m)),
        f && (f = clearInterval(f)))
      : (f || ((p = c.now()), (f = setInterval(j, k))), (a = 1), x(d));
  }
}
export { _ as T, I as d, T as n, D as t };
