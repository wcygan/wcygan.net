...
2. **Cloudflare deploy**: `deno task --eval "wrangler deployments list" | tail -12`. Confirm the newest deploy is newer than the latest push. If not, say so and suggest the dashboard.
