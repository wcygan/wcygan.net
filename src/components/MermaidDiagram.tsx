...
const MERMAID_THEME = {
  ...
  themeVariables: {
    ...
    labelBoxBorderColor: '#5c8b3f',
    labelTextColor: '#000000',
    loopTextColor: '#000000',
    noteBorderColor: '#5c8b3f',
    noteBkgColor: '#f9f9f9',
    noteTextColor: '#000000',
    activationBorderColor: '#5c8b3f',
    activationBkgColor: '#f9f9f9',
    sequenceNumberColor: '#000000',
    specialStateColor: '#5c8b3f',
  ...
  const renderDiagram = useCallback(async () => {
    ...
    try {
      ...
      mermaid.initialize({
        ...
        sequence: {
          useMaxWidth: true, wrap: mobile, actorMargin: 50, width: 150,
          height: 65, boxMargin: 10, boxTextMargin: 5, noteMargin: 10, messageMargin: 35,
        },
        state: { useMaxWidth: true },
        gitGraph: { useMaxWidth: true, mainBranchName: 'main', showBranches: true, showCommitLabel: true },
        class: { useMaxWidth: true },
        pie: { useMaxWidth: true, textPosition: 0.75 },
        gantt: {
          useMaxWidth: true, leftPadding: 75, gridLineStartPadding: 35,
          fontSize: 11, sectionFontSize: 24, numberSectionStyles: 4,
        },
      })
      ...
      // Clean up orphaned render elements mermaid leaves in the DOM
      setTimeout(() => {
