...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    location: "Chicago, IL (Remote)",
    summary:
      "Leveraged Economic Graph data to help Job Seekers discover relevant skills",
  ...
  },
  {
    ...
    location: "San Francisco, CA",
    summary:
      'Created a new type of CYMBII ("courses you might be interested in") in LinkedIn Feed',
