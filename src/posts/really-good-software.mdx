...
_"Ghostty is a terminal emulator that differentiates itself by being fast, feature-rich, and native. While there are many excellent terminal emulators available, they all force you to choose between speed, features, or native UIs. Ghostty provides all three."_

... It's fast and pretty

I used [iterm2](https://iterm2.com/) and [warp](https://www.warp.dev/) before, and I haven't looked back since

Anything other than the MacOS default terminal is fine, but [Ghostty](https://ghostty.org/) is _mega fine_!
...
<aside class="pull-quote">
  <p>
    The right tools don't just save time — they change how you think about the
    work itself.
  </p>
</aside>
